      ...
      >
        <defs>
          <clipPath id="clip-path">
            <path
                d="M241.019 115.687l-7.173 163.792H126.245l-5.978-163.792"
                fill="none"
            />
          </clipPath>
        </defs>
        ...
        <path
            ...
            opacity=".25"
        />
        <circle className="cls-3" cx="180.046" cy="133.621" r="129.121" />
        <circle cx="180.046" cy="133.621" fill="#e6f5f8" r="124.339" />
        <circle cx="180.046" cy="136.012" fill="#d0e8f0" r="101.623" />
        <circle className="cls-13" cx="139.396" cy="37.976" r="5.978" />
        <g id="Body">
          <path
              className="cls-6"
          ...
          <g clipPath="url(#clip-path)">
            <circle className="cls-6" cx="181.241" cy="150.359" r="106.405" />
          </g>
        </g>
        <g id="Face">
          <circle
              ...
              r="8.369"
          />
          <circle className="cls-2" cx="221.89" cy="151.554" r="37.062" />
          <circle className="cls-2" cx="138.201" cy="151.554" r="37.062" />
          <circle className="cls-13" cx="221.89" cy="151.554" r="28.694" />
          <circle className="cls-13" cx="135.81" cy="151.554" r="28.694" />
          <circle className="cls-12" cx="135.81" cy="147.968" r="8.369" />
          <circle className="cls-12" cx="221.89" cy="147.968" r="8.369" />
          <path
              className="cls-12"
